...
class BuHaftaHepsiniGorSayfa extends StatefulWidget {
  final String? aktifKullaniciId;
  const BuHaftaHepsiniGorSayfa({Key? key, this.aktifKullaniciId})
      : super(key: key);

  @override
  _BuHaftaHepsiniGorSayfaState createState() => _BuHaftaHepsiniGorSayfaState();
}

class _BuHaftaHepsiniGorSayfaState extends State<BuHaftaHepsiniGorSayfa> {
  @override
