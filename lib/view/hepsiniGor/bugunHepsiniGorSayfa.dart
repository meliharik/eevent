...
class BugunHepsiniGorSayfa extends StatefulWidget {
  final String? aktifKullaniciId;
  const BugunHepsiniGorSayfa({Key? key, this.aktifKullaniciId})
      : super(key: key);

  @override
  _BugunHepsiniGorSayfaState createState() => _BugunHepsiniGorSayfaState();
}

class _BugunHepsiniGorSayfaState extends State<BugunHepsiniGorSayfa> {
  @override
  ...
  Widget get _etkinlikler => Expanded(
        child: FutureBuilder<List<Etkinlik>>(
          future: FirestoreServisi().bugunEtkinlikleriGetir(false),
